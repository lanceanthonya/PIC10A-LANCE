...
int main(){
    ...
    string filename = user_name + ".txt"; // shorten to the last bit in the final product
    ...
    if (play_game == "n"){ // if the user selects "n", they don't want to play the game and the file for the game ends
        ...
        ofstream new_user_info (filename,  std::ios_base::app ); //creates an output stream to either create a new file with the score or to append the score of the game to an existing user file
