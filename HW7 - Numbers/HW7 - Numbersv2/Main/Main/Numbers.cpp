...
std::string decimalToBinary( std::string  decimal_string ){
...
//    std::string bin = "0";
//    int index = 0;
//    while (lessThanOrEqual(twoPower(index), decimal_string)){
//        ++index;
//        const int maxPower_adjust = 1;
//
//        const int maxPower = index - maxPower_adjust;
//        for (int index_2 = maxPower; index_2 >= 0; --index_2){
//            if (lessThanOrEqual(twoPower(index_2), decimal_string)){
//                bin += "1";
//                const int dec_base10 = 10;
//                decimal_string = subtract(decimal_string,twoPower(index_2),dec_base10);
//            }
//
//            else{
//                bin += "0";
...
//    return decimal_num; // the final value of the decimal converted from binary
    std::string bin = binary_string;
    reverseString(bin);
    std::string dec = "0";
    for (int index = 0; index <= bin.length(); ++index){
        int binary_1 = 1;
        if (charToDigit(bin[index])==binary_1){
